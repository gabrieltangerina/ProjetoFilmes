function verificar(){
    ...
    if(fAno.value >= 1970 && fAno.value < 1980){
        ...
        img.setAttribute('src', 'imagens/rock-70.png')
        res.appendChild(img)
    ...
    if(fAno.value >= 1980 && fAno.value < 1990){
        ...
        img.setAttribute('src' , 'imagens/et-80.png')
        res.appendChild(img)
    ...
    if(fAno.value >= 1990 && fAno.value < 2000){
        ...
        img.setAttribute('src' , 'imagens/forestgump-90.png')
        res.appendChild(img)
    ...
    if(fAno.value >= 2000 && fAno.value < 2010){
        ...
        img.setAttribute('src', 'imagens/batman-00.png')
        res.appendChild(img)
    ...
    if(fAno.value >= 2010 && fAno.value < 2020){
        ...
        img.setAttribute('src','imagens/gentegrande-10.png')
        res.appendChild(img)
    ...
    if(fAno.value >= 2020){
        ...
        img.setAttribute('src','imagens/vingancacastigo-20.png')
        res.appendChild(img)
